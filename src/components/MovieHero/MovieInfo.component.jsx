        ...
        <div>
            <div className="flex items-center gap-3 lg:gap-8">
                <div className="w-40 h-8">
                    <img src="" alt="premier" className="w-full h-full" />
                </div>
                <span className="bg-bms-700 p-1 text-xs text-white rounded-md">Streaming now</span>
            </div>
            <h1 className="text-white lg:text-5xl hidden lg:block font-bold">Justice League</h1>
            ...
            <div className="text-white font-light flex flex-col gap-2">
                ...
                <h4>1hr 53m &bull; Action, Sci-Fi, Thriller &bull; 13+</h4>
            </div>
